...
if !isfile(result_file)
	...
	time_simple_output = @elapsed result_output = optimize(simple_mipverify_net, main_solver, tightening_solver, simple_output_problem)
	time_simple_input = @elapsed result_input = optimize(simple_mipverify_net, main_solver, tightening_solver, simple_input_problem)
